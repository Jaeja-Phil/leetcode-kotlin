...
fun main() {
    ...
    println(findJudge(2, arrayOf(intArrayOf(1, 2)))) // 2
    println(findJudge(3, arrayOf(intArrayOf(1, 3), intArrayOf(2, 3)))) // 3
    println(findJudge(3, arrayOf(intArrayOf(1, 3), intArrayOf(2, 3), intArrayOf(3, 1)))) // -1
}
