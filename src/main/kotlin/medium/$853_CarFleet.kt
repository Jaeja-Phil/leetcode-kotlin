...
fun main() {
    ...
    println(carFleet(target, position, speed)) // 3

    val target2 = 10
    val position2 = intArrayOf(3)
    val speed2 = intArrayOf(3)
    println(carFleet(target2, position2, speed2)) // 1

    val target3 = 100
    val position3 = intArrayOf(0, 2, 4)
    val speed3 = intArrayOf(4, 2, 1)
    println(carFleet(target3, position3, speed3)) // 1
}